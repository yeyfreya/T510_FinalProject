...
def main():
    ...
    if st.session_state.emotion_history:
        ...
        squares_html = ""
        for emotion, time in st.session_state.emotion_history[-20:]:  # Last 20 emotions
            ...
            <div style="background-color: {color}; color: {text_color};
                ...
                <strong style="font-size: 0.7rem;">{emotion[:3]}</strong>
            </div>
            """
        ...
        full_html = container_html_start + squares_html + container_html_end
